			  				...
			  				<div class="panel-body">
								...
								<!--  -->
								    ...
								    <div class="col-sm-offset-2 col-sm-10" >
								  			  <button class="btn btn-success" id="acak" onclick="redirect('control2.php?sjam=RP&&shari=RP')" style="margin-bottom: 20px;" > Acak Jadwal </button> 
								  </div>
								
								<!--  -->

			  					<!--  -->
			  					<form class="form-horizontal" role="form" method="POST" action="control.php?kc=jadwal1up">
								<!--  -->
								<div class="form-group">
									...
									$kode_jadwal_new = $waktu . sprintf("%03s", $urutan);
											...
											$kode_jadwal_new = "UP".date('Ydm')."001"; }
										}
...
FROM data_acak_up as a LEFT JOIN 
     plot_up as b ON a.kode_up = b.kode_up
