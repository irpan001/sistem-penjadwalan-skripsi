			  				...
			  				<div class="panel-body">
								...
								<!--  -->
								    ...
								    <div class="col-sm-offset-2 col-sm-10" >
								  			  <button class="btn btn-success" id="acak" onclick="redirect('control2.php?sjam=W&&shari=W')" style="margin-bottom: 20px;" > Acak Jadwal </button> 
								  </div>
								
								<!--  -->

			  					<!--  -->
			  					<form class="form-horizontal" role="form" method="POST" action="control.php?kc=jadwal1w">
								<!--  -->
								<div class="form-group">
								    ...
								    <div class="col-sm-10">
								    	...
								    	<?php
								    		  $sp=  "SELECT max(kode_jadwal) as kode_jadwal FROM jadwal_kuliah;";
                        					// echo $sp;
									...
									$kode_jadwal_new = $waktu . sprintf("%03s", $urutan);
											...
											$kode_jadwal_new = "W".date('Ydm')."001"; }
										}
