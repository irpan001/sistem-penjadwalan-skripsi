			  				...
			  				<div class="panel-body">
								...
								<!--  -->
								    ...
								    <div class="col-sm-offset-2 col-sm-10" >
								  			  <button class="btn btn-success" id="acak" onclick="redirect('control_sh.php?sjam=RP&&shari=RP')" style="margin-bottom: 20px;" > Acak Jadwal </button> 
								  </div>
								
								<!--  -->

			  					<!--  -->
			  					<form class="form-horizontal" role="form" method="POST" action="control.php?kc=jadwal1sh">
								<!--  -->
								<div class="form-group">
									...
									$kode_jadwal_new = $waktu . sprintf("%03s", $urutan);
											...
											$kode_jadwal_new = "SH".date('Ydm')."001"; }
										}
		  	...
		  	<div class="row">
		  		<div class="col-md-12 panel-warning">
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Data Seminar Hasil</div>
...
FROM data_acak_semhas as a LEFT JOIN 
     plot_semhas as b ON a.kode_semhas = b.kode_semhas
