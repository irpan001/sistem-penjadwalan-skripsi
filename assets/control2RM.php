...
session_start();
    ...
    // data polot kelas
    $sql_kelas =  "SELECT a.kode_kelas, a.matakuliah, a.dosen, b.jml_sks FROM plot_kelas as a, matakuliah as b where a.matakuliah = b.kode_matkul AND a.sesi = 2;";
    ...
    // data hari
    $sql_hari =  "SELECT * FROM hari WHERE keterangan_hari = 'RP'";
...
// end class
 ...
 echo '<META HTTP-EQUIV="Refresh" Content="0; URL=index.php?page=82&&fit='.$fitness.'">';
